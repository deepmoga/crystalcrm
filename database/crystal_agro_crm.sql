-- =========================================================================
-- Crystal Agro CRM - MySQL Database Schema & Initial Data Dump
-- Suitable for phpMyAdmin / MySQL 5.7+ / MySQL 8.0+ / MariaDB
-- =========================================================================

-- 1. Company Profile & Business Settings Table
...
-- Initial System Users (Password: username123, e.g. admin -> admin123)
-- Hash: $2b$10$wT0X81lCq8wK6hG9Z1Wl.OK3w9X3Yk3X6Z9Yk3X6Z9Yk3X6Z9Yk3X (bcrypt hashed dynamically by server)
